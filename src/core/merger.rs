...
fn merge_pumpfun_trade(base: &mut PumpFunTradeEvent, inner: PumpFunTradeEvent) {
    ...
    if leg {
        ...
        put_u64_if_nonzero(
            &mut base.cashback_fee_basis_points,
            inner.cashback_fee_basis_points,
        );
        put_u64_if_nonzero(&mut base.cashback, inner.cashback);
        put_u64_if_nonzero(
            &mut base.buyback_fee_basis_points,
            inner.buyback_fee_basis_points,
        );
        ...
        put_u64_if_nonzero(
            &mut base.creator_fee_basis_points,
            inner.creator_fee_basis_points,
        );
        put_u64_if_nonzero(&mut base.virtual_sol_reserves, inner.virtual_sol_reserves);
        put_u64_if_nonzero(
            &mut base.virtual_token_reserves,
            inner.virtual_token_reserves,
        );
        ...
        put_u64_if_nonzero(
            &mut base.total_unclaimed_tokens,
            inner.total_unclaimed_tokens,
        );
    ...
    put_pk_if_set(
        ...
        inner.associated_bonding_curve,
    );
    ...
    put_pk_if_set(
        &mut base.associated_token_program,
        inner.associated_token_program,
    );
    put_pk_if_set(&mut base.creator_vault, inner.creator_vault);
    put_pk_if_set(
        &mut base.associated_quote_fee_recipient,
        inner.associated_quote_fee_recipient,
    );
    ...
    put_pk_if_set(
        &mut base.associated_quote_bonding_curve,
        inner.associated_quote_bonding_curve,
    );
    put_pk_if_set(&mut base.associated_quote_user, inner.associated_quote_user);
    put_pk_if_set(
        &mut base.associated_creator_vault,
        inner.associated_creator_vault,
    );
    ...
    put_pk_if_set(
        &mut base.global_volume_accumulator,
        inner.global_volume_accumulator,
    );
    put_pk_if_set(
        &mut base.user_volume_accumulator,
        inner.user_volume_accumulator,
    );
    put_pk_if_set(
...
fn merge_pumpfun_create_v2(base: &mut PumpFunCreateV2TokenEvent, inner: PumpFunCreateV2TokenEvent) {
    ...
    put_pk_if_set(&mut base.program, inner.program);
    put_pk_if_set(
        &mut base.observed_fee_recipient,
        inner.observed_fee_recipient,
    );
}
...
fn merge_pumpfun_trade_log_preferred(log: &mut PumpFunTradeEvent, ix: PumpFunTradeEvent) {
    ...
    fill_pk(
        &mut log.associated_token_program,
        ix.associated_token_program,
    );
    ...
    fill_pk(
        &mut log.associated_quote_fee_recipient,
        ix.associated_quote_fee_recipient,
    );
    ...
    fill_pk(
        &mut log.associated_quote_bonding_curve,
        ix.associated_quote_bonding_curve,
    );
    fill_pk(&mut log.associated_quote_user, ix.associated_quote_user);
    fill_pk(
        &mut log.associated_creator_vault,
        ix.associated_creator_vault,
    );
    ...
    fill_pk(
        &mut log.global_volume_accumulator,
        ix.global_volume_accumulator,
    );
    fill_pk(&mut log.user_volume_accumulator, ix.user_volume_accumulator);
    fill_pk(
        &mut log.associated_user_volume_accumulator,
        ix.associated_user_volume_accumulator,
    );
...
fn merge_pumpswap_buy_log_preferred(log: &mut PumpSwapBuyEvent, ix: PumpSwapBuyEvent) {
    ...
    fill_pk(
        &mut log.user_quote_token_account,
        ix.user_quote_token_account,
    );
    ...
    fill_pk(
        &mut log.pool_quote_token_account,
        ix.pool_quote_token_account,
    );
    ...
    fill_pk(&mut log.fee_recipient, ix.fee_recipient);
    fill_pk(
        &mut log.fee_recipient_quote_token_account,
        ix.fee_recipient_quote_token_account,
    );
    if log.ix_name.is_empty() && !ix.ix_name.is_empty() {
        log.ix_name = ix.ix_name;
    }
