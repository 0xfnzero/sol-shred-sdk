...
fn parse_initialize_lb_pair_instruction(
    ...
    Some(DexEvent::MeteoraDlmmInitializePool(
...
fn parse_initialize_bin_array_instruction(
    ...
    Some(DexEvent::MeteoraDlmmInitializeBinArray(
...
fn parse_add_liquidity_instruction(
    ...
    Some(DexEvent::MeteoraDlmmAddLiquidity(
        MeteoraDlmmAddLiquidityEvent {
            ...
            amounts: [
                amounts.first().copied().unwrap_or(0),
...
fn parse_remove_liquidity_instruction(
    ...
    Some(DexEvent::MeteoraDlmmRemoveLiquidity(
...
fn parse_initialize_position_instruction(
    ...
    Some(DexEvent::MeteoraDlmmCreatePosition(
...
fn parse_close_position_instruction(
    ...
    Some(DexEvent::MeteoraDlmmClosePosition(
