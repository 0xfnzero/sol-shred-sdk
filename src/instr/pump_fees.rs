...
pub fn parse_instruction(
    ...
    if disc == UPDATE_FEE_SHARES_IX || disc == UPDATE_FEE_SHARES_V2_IX {
        ...
        return Some(DexEvent::PumpFeesUpdateFeeShares(
    ...
    if disc == INITIALIZE_FEE_CONFIG_IX {
        ...
        return Some(DexEvent::PumpFeesInitializeFeeConfig(
    ...
    if disc == UPDATE_FEE_CONFIG_IX {
        ...
        return Some(DexEvent::PumpFeesUpdateFeeConfig(
    ...
    if disc == UPSERT_FEE_TIERS_IX {
        ...
        return Some(DexEvent::PumpFeesUpsertFeeTiers(
